...
import org.iesalixar.daw2.GarikAsatryan.dwese_ticket_logger_api.dtos.FilterDTO;
import org.iesalixar.daw2.GarikAsatryan.dwese_ticket_logger_api.dtos.ProductDTO;
import org.iesalixar.daw2.GarikAsatryan.dwese_ticket_logger_api.dtos.ResponseDTO;
import org.iesalixar.daw2.GarikAsatryan.dwese_ticket_logger_api.entities.Product;
import org.iesalixar.daw2.GarikAsatryan.dwese_ticket_logger_api.mappers.ProductMapper;
...
public class ProductService {
    ...
    public ResponseDTO list(FilterDTO filterDTO) {
        try {
            Pageable pageable = PageRequest.of(filterDTO.getPage() - 1, filterDTO.getItemsPerPage(), "desc".equals(filterDTO.getOrderBy()) ? Sort.by(filterDTO.getOrder()).descending() : Sort.by(filterDTO.getOrder()).ascending());
